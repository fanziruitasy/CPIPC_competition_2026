...
def parse_funds(
    ...
    period_source = Path(source_file_name) if source_file_name else path
    quarter, period_start, period_end = quarter_from_filename(period_source, year)
